...
import { BM25_INDEX, DOC_TERM_FREQUENCIES, DOC_LENGTHS } from "@/almendro/loaders/loadBM25";
import type { ScoredResult } from "./dense";

// Okapi BM25 defaults, matching Python rank_bm25's BM25Okapi (same constants
// as the site's own src/rag/retrieval/sparse.ts).
const K1 = 1.5;
const B = 0.75;
